        ...
        <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px] gap-6">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-blue-200/70 bg-blue-50 text-xs font-medium text-blue-700 transition-all duration-200 hover:border-blue-300 hover:bg-blue-100 dark:border-blue-900/60 dark:bg-blue-950/40 dark:text-blue-400 dark:hover:border-blue-800 dark:hover:bg-blue-900/30">
                    ...
                    <section class="group rounded-2xl border border-border bg-card shadow-sm overflow-hidden transition-all duration-300 hover:border-blue-200 hover:shadow-md dark:border-slate-700 dark:hover:border-blue-800/70">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8">
                            ...
                            @foreach($solicitud->datos_extra as $campo => $valor)
                                ...
                                <div class="px-6 py-4 border-b border-border transition-colors duration-200 hover:bg-primary/[0.025] last:border-b-0 sm:[&:nth-last-child(-n+2)]:border-b-0 dark:border-slate-700 dark:hover:bg-slate-800/40">
            ...
            <aside class="space-y-5">
                ...
                @else
                    ...
                    <section class="group rounded-2xl border border-border bg-muted/20 p-5 transition-all duration-300 hover:border-primary/15 hover:bg-primary/[0.025] dark:border-slate-700 dark:bg-slate-900/40 dark:hover:border-blue-800/70 dark:hover:bg-slate-800/40">
