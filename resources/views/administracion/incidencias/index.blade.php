...
<div class="min-h-screen bg-background">
    ...
    <main class="max-w-7xl mx-auto px-6 py-10">
        ...
        <section class="mb-10">
            ...
            <div class="mb-5">
                <h2 class="text-base font-semibold text-foreground">Resumen de incidencias</h2>
                <p class="mt-1 text-sm text-muted-foreground">Estado actual de las incidencias registradas en el portal.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div class="group relative overflow-hidden rounded-2xl border border-cyan-200/60 bg-gradient-to-br from-cyan-50 via-white to-blue-50/60 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/10 dark:border-cyan-900/60 dark:from-cyan-950/25 dark:via-slate-900 dark:to-blue-950/20 dark:hover:border-cyan-800/70">

                    <div class="absolute -right-8 -top-8 w-24 h-24 rounded-full bg-cyan-400/10 pointer-events-none transition-all duration-500 group-hover:scale-150 group-hover:bg-cyan-400/20"></div>

                    <div class="relative flex items-center gap-4">

                        <div class="flex items-center justify-center w-11 h-11 shrink-0 rounded-xl bg-cyan-500/10 text-cyan-600 transition-all duration-300 group-hover:scale-105 group-hover:bg-cyan-100 dark:bg-cyan-500/15 dark:text-cyan-400 dark:group-hover:bg-cyan-900/40">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <span
                                        @class([
                                            ...
                                            'border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-700/40 dark:bg-amber-950/30 dark:text-amber-400' =>
                                                $incidencia->prioridad === \App\Models\Incidencia::PRIORIDAD_ALTA,

                                            'border-red-200 bg-red-50 text-red-700 dark:border-red-900/70 dark:bg-red-950/30 dark:text-red-400' =>
