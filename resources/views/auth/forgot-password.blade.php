                ...
                <div class="relative z-10 flex flex-1 items-center px-10 py-12 pl-12 xl:px-12 xl:pl-14">
                    ...
                    <div class="max-w-md">
                        ...
                        <p class="mt-5 text-[15px] leading-7 text-slate-600">
                            Ingresa el correo asociado a tu cuenta para iniciar
                        ...
                        <div class="mt-9 space-y-5">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs leading-5 text-slate-500">
                                        Se utilizará el correo electrónico registrado
                                        en tu cuenta del portal.
                                    </p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs leading-5 text-slate-500">
                                        La recuperación se realiza conforme a las
                        ...
                        <div class="mt-10 border-l-2 border-blue-200 pl-4">
                            ...
                            <p class="text-sm italic leading-6 text-slate-500">
                                Nunca compartas enlaces, códigos de recuperación
                                ni credenciales con otras personas.
                            </p>
            ...
            <section class="flex min-h-[680px] items-center justify-center bg-white px-6 py-10 sm:px-10 lg:px-14 xl:px-20">
                ...
                <div class="auth-form-content w-full max-w-md">
                    ...
                    >
                        ...
                        {{-- Información --}}
                        <div class="flex items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5">
                            ...
                            <p class="text-xs leading-5 text-slate-500">
                                Si el correo está asociado a una cuenta válida,
                                recibirás las instrucciones para continuar con
                                la recuperación.
                            </p>
                    ...
                    <div class="mt-8 border-t border-slate-200 pt-7">
                        ...
                        <a
                            href="{{ route('login') }}"
                            class="group flex items-center justify-center gap-2 text-sm font-semibold text-blue-600 transition hover:text-blue-700"
                        >
                    ...
                    <div class="mt-8 flex items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5">
                        ...
                        <p class="text-xs leading-5 text-slate-500">
                            El proceso puede tardar unos segundos. No compartas
                            información sensible, códigos ni credenciales.
                        </p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const recoveryButtonText =
            document.getElementById('recoveryButtonText');

        const recoveryArrow =
            document.getElementById('recoveryArrow');

        const recoverySpinner =
            document.getElementById('recoverySpinner');
        ...
        if (
            ...
            recoveryForm.addEventListener('submit', function () {
                ...
                recoveryButtonText.textContent =
                    'Enviando solicitud...';

                recoveryArrow.classList.add('hidden');
