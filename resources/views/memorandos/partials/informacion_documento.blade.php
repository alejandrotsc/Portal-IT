        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div>
                ...
                <div
                    ...
                    class="flex min-h-11 w-full items-center gap-2.5 rounded-lg border border-border bg-muted/50 px-3.5 py-2.5 text-sm font-medium text-foreground">
            ...
            <div>
                ...
                <div
                    ...
                    <i
                        ...
                        stroke-width="1.8"
                        class="h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200 group-focus-within/field:rotate-180 group-focus-within/field:text-primary">
                    </i>
            ...
            <div>
                ...
                <div
                    ...
                    <input
                        ...
                        required
                        class="w-full border-0 bg-transparent py-2.5 text-sm text-foreground focus:outline-none focus:ring-0">
