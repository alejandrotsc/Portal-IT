    ...
    >
        ...
        >
            ...
            <section class="group relative overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-all duration-300 hover:border-primary/20 hover:shadow-md dark:border-slate-700/70 dark:hover:border-blue-700/70 dark:hover:shadow-black/20">
                ...
                <div class="relative flex items-center gap-3 border-b border-border bg-gradient-to-r from-primary/[0.06] via-white to-blue-50/40 dark:border-slate-700/70 dark:from-blue-950/30 dark:via-slate-900 dark:to-slate-900 px-6 py-4">
                ...
                <div class="relative px-6 py-5">
                    ...
                    <div
                        class="group/type inline-flex w-full max-w-md items-center gap-3 rounded-xl border border-primary/30 bg-gradient-to-br from-primary/[0.08] via-white to-blue-50/70 dark:border-blue-800/60 dark:from-blue-950/35 dark:via-slate-900 dark:to-blue-950/25 px-4 py-3.5 shadow-sm transition-all duration-300 hover:border-primary/50 hover:shadow-md dark:hover:border-blue-700/80 dark:hover:shadow-black/20 motion-safe:hover:-translate-y-0.5"
                    >
                        <div
