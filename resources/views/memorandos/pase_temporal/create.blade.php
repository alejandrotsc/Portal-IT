...
{{-- El form no necesita action/POST real; el JS abre Outlook --}}
<form id="documentForm">


    <input type="hidden" name="tipo_documento" value="pase_temporal">
    <input type="hidden" name="tipo_id"        value="{{ $tipoPase->id }}">
    ...
    <div class="max-w-[1300px] mx-auto px-6 space-y-5">
            ...
            <div class="flex items-start justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground mt-1">
                        Complete los campos requeridos para enviar el pase temporal a Helpdesk.
                    </p>
                </div>

                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 text-xs font-medium border border-blue-100">
        ...
        <div class="bg-card rounded-2xl border border-border overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-border flex items-center gap-3">
                ...
                <h2 class="text-sm font-semibold text-foreground">Tipo de gestión</h2>
            </div>
            ...
            <div class="px-6 py-5">
                <div class="inline-flex items-center gap-3 px-4 py-3.5 rounded-xl border-2 border-primary bg-primary/5 cursor-pointer">
                    ...
                    <div class="mr-3">
                        <p class="text-sm font-semibold text-primary">{{ $tipoPase->nombre_visual }}</p>
                        <p class="text-xs text-muted-foreground mt-0.5">Solicitud de acceso temporal de corta duración</p>
                    </div>
