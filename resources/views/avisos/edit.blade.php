...
<div class="min-h-screen bg-background">
    ...
    <main class="max-w-3xl mx-auto px-6 py-10">
        ...
        <section class="group/status relative overflow-hidden mb-5 rounded-2xl border border-blue-200/60 bg-gradient-to-br from-blue-50/80 via-white to-indigo-50/60 p-5 shadow-sm transition-all duration-300 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/10 motion-safe:hover:-translate-y-0.5 dark:border-blue-900/60 dark:from-blue-950/30 dark:via-slate-900 dark:to-indigo-950/20 dark:hover:border-blue-800/70">
            ...
            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="shrink-0">
                    ...
                    @if($aviso->estaVisible())
                        ...
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-emerald-200/60 bg-emerald-500/10 text-emerald-700 text-xs font-medium transition-colors duration-200 hover:bg-emerald-100 dark:border-emerald-900/60 dark:bg-emerald-500/15 dark:text-emerald-400 dark:hover:bg-emerald-900/30">
                    ...
                    @elseif($aviso->estaProgramado())
                        ...
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-amber-200/60 bg-amber-500/10 text-amber-700 text-xs font-medium transition-colors duration-200 hover:bg-amber-100 dark:border-amber-700/40 dark:bg-amber-500/15 dark:text-amber-400 dark:hover:bg-amber-900/30">
                    ...
                    @elseif($aviso->estaFinalizado())
                        ...
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-slate-200 bg-slate-500/10 text-slate-600 text-xs font-medium transition-colors duration-200 hover:bg-slate-200 dark:border-slate-700 dark:bg-slate-700/50 dark:text-slate-300 dark:hover:bg-slate-700">
