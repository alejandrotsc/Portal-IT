...
<div
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px] gap-6">
                    ...
                    <section class="group rounded-2xl border border-border bg-card shadow-sm overflow-hidden transition-all duration-300 hover:border-primary/15 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6">
                            ...
                            @foreach($incidencia->archivos as $archivo)
                                ...
                                <article class="group/file overflow-hidden rounded-xl border border-border bg-background transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/15 hover:shadow-md">
                                    ...
                                    <button
                                        ...
                                        <span class="absolute inset-0 flex items-center justify-center bg-slate-950/0 text-white opacity-0 transition-all duration-300 group-hover/file:bg-slate-950/25 group-hover/file:opacity-100">
                                            ...
                                            <span class="flex items-center justify-center w-10 h-10 rounded-full bg-white/90 text-primary shadow-sm backdrop-blur-sm">
                ...
                <section class="group rounded-2xl border border-border bg-card shadow-sm overflow-hidden transition-all duration-300 hover:border-primary/15 hover:shadow-md">
                    ...
                    <div class="p-6">
                        ...
                        @else
                            ...
                            <div class="group/mail flex items-start gap-3 rounded-xl border border-red-200 bg-red-50/70 p-4 transition-all duration-300 hover:border-red-300 hover:bg-red-50 hover:shadow-sm">

                                <div class="flex items-center justify-center w-9 h-9 shrink-0 rounded-lg bg-red-100 text-red-600 transition-transform duration-300 group-hover/mail:scale-105">
            ...
            <aside class="space-y-5">
                ...
                @elseif($incidencia->estaEnProceso())
                    ...
                    <section class="group relative overflow-hidden rounded-2xl border border-cyan-200/70 bg-gradient-to-br from-cyan-50 via-white to-blue-50/70 p-5 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/10">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex items-center justify-center w-11 h-11 rounded-xl bg-cyan-500/10 text-cyan-700 ring-4 ring-cyan-500/5 transition-transform duration-300 group-hover:scale-105">
                            ...
                            <div class="mt-4 flex flex-wrap items-center gap-2">
                                ...
                                <h2 class="text-sm font-semibold text-cyan-900">
                                    Incidencia en proceso
                                </h2>

                                <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-cyan-500/10 text-[10px] font-semibold uppercase tracking-wide text-cyan-700">
                            ...
                            <p class="mt-2 text-xs leading-relaxed text-cyan-800/80">
    ...
    <div
        ...
        class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/85 p-6 backdrop-blur-sm"
        style="display: none;">
        ...
        <button
            ...
            class="absolute top-5 right-5 inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/80 bg-white/90 text-primary shadow-lg transition-all duration-200 hover:rotate-90 hover:bg-white">
