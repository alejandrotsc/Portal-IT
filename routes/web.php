...
Route::middleware('auth')->group(function () {
    ...
    |--------------------------------------------------------------------------
    */
    Route::get('/memorandos', [MemorandoController::class, 'create'])->name('memorandos.create');
    Route::post('/memorandos', [MemorandoController::class, 'store'])->name('memorandos.store');

    // Accesos directos Usuario Cliente
    Route::get('/memorandos/pase-temporal', [MemorandoController::class, 'createPaseTemporal'])->name('memorandos.pase_temporal');
    Route::post('/memorandos/pase-temporal', [MemorandoController::class, 'storePaseTemporal'])->name('memorandos.pase_temporal.store');
    Route::get('/memorandos/autorizacion', [MemorandoController::class, 'createAutorizacion'])->name('memorandos.autorizacion');

    // Solicitud compra
    Route::get('/memorandos/compra', [MemorandoController::class, 'createCompra'])->name('memorandos.create.compra');

    // Formularios dinámicos
    Route::get('/memorandos/formulario/{tipo}', [MemorandoController::class, 'formularioDinamico'])->name('memorandos.formulario');

    // Previews dinámicos
    Route::get('/memorandos/preview/{tipo}', [MemorandoController::class, 'previewDinamico'])->name('memorandos.preview');

    // Histórico memorandos
    Route::get('/memorandos/historico', [MemorandoController::class, 'historico'])->name('memorandos.historico');
...
Route::middleware(['auth', 'rol:Administrador'])->group(function () {
    ...
    Route::get('/administracion/incidencias', [IncidenciaController::class, 'administracion'])->name('admin.incidencias');
    Route::post('/administracion/incidencias/{incidencia}/asignar', [IncidenciaController::class, 'asignar'])->name('admin.incidencias.asignar');
});